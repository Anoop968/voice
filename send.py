...
class JarvisGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Malayalam JARVIS")
        ...
        self.text_console = tk.Label(root, text="🪔 Malayalam JARVIS Starting...",
    ...
    def assistant_loop(self):
        ...
        while True:
            ...
            if any(word in text for word in WAKE_WORDS):
                speak("""നമസ്കാരം. ഞാൻ പോൾ — നിങ്ങളുടെ മലയാളം വോയ്സ് അസിസ്റ്റന്റ്. 
എനിക്ക് എന്ത് സഹായം വേണം?""")
